---
title: "How to Read an ETF Fact Sheet: A Complete Beginner's Guide (2026)"
...
You can find it on the fund provider's website (e.g., [investor.vanguard.com](https://investor.vanguard.com) for VOO, [ishares.com](https://ishares.com) for IVV) or through your brokerage platform.
...
| Fund Provider | URL |
|---|---|
| **Vanguard** (VOO, VTI, VXUS) | [investor.vanguard.com](https://investor.vanguard.com) → search ticker → "Facts & holdings" |
| **iShares / BlackRock** (IVV, ICLN, EWH) | [ishares.com](https://ishares.com) → search ticker → "Literature" |
| **State Street / SPDR** (SPY, GLD) | [ssga.com](https://ssga.com) → search ticker → "Documents" |
| **Invesco** (QQQ, QQQM) | [invesco.com](https://invesco.com) → search ticker → "Documents" |
