---
title: "Energy Sector ETFs 2026: XLE vs VDE vs IXC vs FENY — Oil, Pipelines, and the Geopolitical Premium"
...
1. [Why Energy Now? The 2026 Context](#why-energy)
2. [The Big Four: XLE vs VDE vs IXC vs FENY](#big-four)
3. [ExxonMobil and Chevron: The Two-Headed Giant](#exxon-chevron)
4. [Midstream MLP ETFs: AMLP vs MLPX — Pipelines Are Different](#midstream)
5. [Clean Energy ETFs: The Contrarian Counterpoint](#clean-energy)
6. [Sizing Energy in a Portfolio: Sector Bets vs Market Neutrality](#sizing)
...
| ETF | Ticker | Expense Ratio | Index | Holdings | Dividend Yield |
|-----|--------|--------------|-------|----------|---------------|
| Energy Select Sector SPDR | XLE | 0.09% | S&P 500 Energy Sector | ~22 | ~3.5% |
| Vanguard Energy ETF | VDE | 0.10% | MSCI US Investable Market Energy 25/50 | ~110 | ~3.4% |
| iShares Global Energy ETF | IXC | 0.41% | S&P Global 1200 Energy Sector | ~50 | ~3.2% |
| Fidelity MSCI Energy ETF | FENY | 0.08% | MSCI US Investable Market Energy 25/50 | ~110 | ~3.4% |
...
| Options market | Very liquid | Moderate |
...
| Consecutive dividend increases | 41 years | 37 years |
...
| ETF | Ticker | Expense Ratio | Structure | Yield | Tax Reporting |
|-----|--------|--------------|-----------|-------|--------------|
| Alerian MLP ETF | AMLP | 0.85% | C-Corp (holds MLPs) | ~7-8% | 1099 (no K-1) |
| Global X MLP & Energy Infrastructure ETF | MLPX | 0.45% | Open-end fund | ~5-6% | 1099 (no K-1) |
| Alerian Energy Infrastructure ETF | ENFR | 0.35% | Open-end fund | ~4% | 1099 |
...
| ETF | Ticker | Expense Ratio | Holdings | Strategy |
|-----|--------|--------------|----------|----------|
| iShares Global Clean Energy ETF | ICLN | 0.40% | ~100 | Global clean energy companies |
| Invesco Solar ETF | TAN | 0.67% | ~40 | Pure solar exposure |
| First Trust NASDAQ Clean Edge Green Energy ETF | QCLN | 0.58% | ~50 | US-focused clean energy |
...
| Approach | Energy Allocation | Vehicle | Rationale |
|----------|------------------|---------|-----------|
| Market neutral | ~4% (through VOO/VTI) | None needed | The market weights energy appropriately; don't second-guess it |
| Income tilt | ~8-10% (add 5% sector ETF) | VDE or FENY | Capture the 4% dividend yield and buyback return as a yield enhancer |
