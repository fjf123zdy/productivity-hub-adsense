---
title: "Covered Call ETFs 2026: JEPI vs JEPQ vs XYLD vs DIVO — 8-12% Yields, but at What Cost?"
...
1. [What Is a Covered Call ETF? The Simple Mechanics](#what-it-is)
2. [The Major Players: JEPI, JEPQ, XYLD, QYLD, DIVO](#players)
3. [The Yield: How 8-12% Is Actually Generated](#yield)
4. [The Hidden Costs: Capped Upside, Full Downside](#hidden-costs)
5. [Tax Treatment: Why Covered Call ETF Distributions Are Tax-Inefficient](#tax)
6. [Total Return vs Yield: What the Backtest Shows](#total-return)
7. [When Covered Call ETFs Make Sense — And When They Don't](#when)
...
| ETF | Ticker | Expense Ratio | Distribution Yield | Underlying | Strategy |
|-----|--------|--------------|-------------------|------------|----------|
| JPMorgan Equity Premium Income ETF | JEPI | 0.35% | ~7-9% | Actively managed US large-cap stocks (~130 holdings) | Sells out-of-the-money S&P 500 call options on ~20% of portfolio via ELNs |
| JPMorgan Nasdaq Equity Premium Income ETF | JEPQ | 0.35% | ~9-11% | Actively managed Nasdaq-100-oriented stocks | Same as JEPI but with Nasdaq-100 call options |
| Global X S&P 500 Covered Call ETF | XYLD | 0.60% | ~8-10% | S&P 500 (all 500 stocks) | Sells at-the-money calls on 100% of the portfolio monthly |
| Global X Nasdaq 100 Covered Call ETF | QYLD | 0.60% | ~10-12% | Nasdaq-100 (all 100 stocks) | Same as XYLD but on Nasdaq-100 |
| Amplify CWP Enhanced Dividend Income ETF | DIVO | 0.55% | ~4-5% | Actively managed ~25 large-cap dividend stocks | Sells covered calls selectively on individual stocks |
...
| Market Scenario | S&P 500 Return | JEPI Approximate Return | XYLD Approximate Return |
|----------------|---------------|------------------------|------------------------|
...
| Fund | Annualized Total Return | Annualized Distribution Yield |
|------|------------------------|------------------------------|
